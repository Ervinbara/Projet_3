var Signature = {
    ...
    convertTouchEvent : function(ev) {
        ...
        switch (ev.type) { 
            ...
            case 'touchmove':
                ...
                break;
            case 'touchend':
                // S'assure que le doigt a été enlever de la cible
    ...
    deplacementSouris : function(event) {
        ...
        this.dessin(positionX, positionY); //Appel de la méthode this.dessin() qui permet d'initier le tracer
    },
    ...
    dessin : function(positionX, positionY) {
        ...
        this.context.lineWidth = 3; // Largeur du tracer

        if(this.ecriture){ //Si ecriture = true
    ...
    activationDessin : function() {
        ...
        this.context.beginPath(); // Permet d'initié le dessin
